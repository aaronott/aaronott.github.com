...
220
```
![img of ftp output](/blog/assets/images/stapler/image.png)

We are able to login anonymously and find that there is a file available for download.

![img of ftp output](/blog/assets/images/stapler/image2.png)

Download the note and read it:
Elly, make sure you update the payload information. Leave it in your FTP account once your are done, John.

![img of ftp output](/blog/assets/images/stapler/image3.png)

Using nmap to get the version of FTP: vsftpd 2.0.8 or later

![img of ftp output](/blog/assets/images/stapler/image13.png)
...
![image of gibberish](/blog/assets/images/stapler/image4.png)

If we capture this gibberish out to a file.

![image of gibberish](/blog/assets/images/stapler/image5.png)

We see that it's a zip file.

![img message2.jpg](/blog/assets/images/stapler/image6.png)
...
![img mysql version](/blog/assets/images/stapler/image7.png)

**Port 12380:**

Using curl, I looked at http and https for this port to find that https was a bit more promising.

![img curl 12380](/blog/assets/images/stapler/image8.png)

![img curl 12380 https](/blog/assets/images/stapler/image9.png)

![img browser 12380 https](/blog/assets/images/stapler/image10.png)

I ran gobuster to enumerate directories using a wordlist and found some interesting directories.

![gobuster](/blog/assets/images/stapler/image11.png)

In announcements, there is a message that could lead to more information, but not super helpful to us right now.

![announcements](/blog/assets/images/stapler/image12.png)
...
![announcements](/blog/assets/images/stapler/image20.png)
...
![Bruteforce](/blog/assets/images/stapler/image14.png)
...
![access through ssh](/blog/assets/images/stapler/image15.png)
...
![logrotate](/blog/assets/images/stapler/image16.png)

`ls -l /usr/local/sbin/cron-logrotate.sh`

`cat /usr/local/sbin/cron-logrotate.sh`

![logrotate](/blog/assets/images/stapler/image17.png)
...
![reverse shell in script](/blog/assets/images/stapler/image18.png)

All that was left was to create a netcat listener on my attacking machine to listen for the reverse shell :-)

![reverse shell connects](/blog/assets/images/stapler/image19.png)
